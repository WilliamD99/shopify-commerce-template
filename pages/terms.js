      ...
      <div className="mt-20 flex flex-col px-5 lg:px-20 space-y-5 lg:space-y-10">
        ...
        <div className="lg:px-32 flex flex-col space-y-5">
          ...
          <p>
            ...
            terms “we”, “us” and “our” refer to weTheBest. weTheBest offers this
        ...
        <div className="lg:px-32 flex flex-col space-y-5">
          ...
          <p>
            In no case shall weTheBest, our directors, officers, employees,
        ...
        <div className="lg:lg:px-32 flex flex-col space-y-5">
          ...
          <p>
            Our contact information is posted below: [INSERT TRADING NAME]
            [INSERT EMAIL ADDRESS] [INSERT BUSINESS ADDRESS] [INSERT BUSINESS
            PHONE NUMBER] [INSERT BUSINESS REGISTRATION NUMBER] [INSERT VAT
            NUMBER]
          </p>
        </div>
      </div>
