...
export default function Index() {
    ...
    let [stripeOption, setStripeOption] = useState({clientSecret: "pi_3M7UMTDLvTNEyZ890lBMF7xl_secret_OZvOGEZmIA4UXjrFXK7rJM3Fl"}) //pi_3M7UMTDLvTNEyZ890lBMF7xl_secret_OZvOGEZmIA4UXjrFXK7rJM3Fl

    let { data } = useQuery(
        ["checkout", "allo-ultra-2500-disposable"],
        () => checkoutGet({ id: decryptText("U2FsdGVkX18hUWkOiDfkRKIT7nmAs4u6BbQAi/NVubU6UagHvC4IJlObnKBL8xN7qSN3/ej5OKBGHdJ1/uP5C2aQZe3St/369zdHNoEMTRU9VRvu6c/D1s8kdCZNQ5yffwpMoC3E1dqHsRfQ3Wwf2w==") }),
