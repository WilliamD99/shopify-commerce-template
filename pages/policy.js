    ...
    <>
      <div className="mt-20 flex flex-col px-20 space-y-10">
        ...
        <div className="text-center text-xl">
          ...
          <Link className="ml-2 font-semibold" href="/">
            https://sample-web-app.myshopify.com/
          </Link>{" "}
          (the “Site”).
        </div>
        ...
        <div className="px-32 flex flex-col space-y-5">
          ...
          <p>
            ...
            talking both about Device Information and Order Information. HOW DO
            WE USE YOUR PERSONAL INFORMATION? We use the Order Information that
            ...
            or services. [[INSERT OTHER USES OF ORDER INFORMATION]] We use the
            Device Information that we collect to help us screen for potential
            risk and fraud (in particular, your IP address), and more generally
            ...
            and to assess the success of our marketing and advertising
            campaigns). [[INSERT OTHER USES OF DEVICE INFORMATION, INCLUDING:
            ADVERTISING/RETARGETING]] SHARING YOUR PERSONAL INFORMATION We share
            your Personal Information with third parties to help us use your
            Personal Information, as described above. For example, we use
            ...
            our rights. [[INCLUDE IF USING REMARKETING OR TARGETED ADVERTISING]]
            ...
            http://optout.aboutads.info/. DO NOT TRACK Please note that we do
            not alter our Site’s data collection and use practices when we see a
            Do Not Track signal from your browser. [[INCLUDE IF LOCATED IN OR IF
            ...
            States. DATA RETENTION When you place an order through the Site, we
            will maintain your Order Information for our records unless and
            until you ask us to delete this information. [[INSERT IF AGE
            RESTRICTION IS REQUIRED]] MINORS The Site is not intended for
            individuals under the age of [[INSERT AGE]]. CHANGES We may update
            this privacy policy from time to time in order to reflect, for
            example, changes to our practices or for other operational, legal or
            regulatory reasons. CONTACT US For more information about our
            privacy practices, if you have questions, or if you would like to
            make a complaint, please contact us by e-mail at
            dnam310199@gmail.com or by mail using the details provided below:
            2346 e 27th ave, Vancouver, BC, V5n2X2, Canada
          </p>
        </div>
      </div>
    </>
