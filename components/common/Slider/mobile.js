...
export default function SliderMobile({ data }) {
    ...
    return (
        <div className='custom-slider__desktop pl-2'>
            <div className='flex flex-row space-x-2 my-3'>
                ...
                <div onClick={() => sliderRef.current.slickNext(2)} className='bg-slate-100 hover:bg-slate-200 ease-linear px-3 py-3 rounded-full cursor-pointer'>
