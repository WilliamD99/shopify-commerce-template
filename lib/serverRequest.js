...
let productById = async (params) => {
  const data = await axios.post("/api/admin/query/product-by-id", {
    data: params,
  });
  return data.data;
};
...
let productByHandleApiRoute = async (params) => {
  const data = await axios.post("/api/storefront/query/product-by-handle", {
    data: params
  })
  return data.data
}
...
const productSearchTemp = async (params) => {
  const data = await axios.post("/api/admin/query/product-search-temp", {
    data: params,
  });
  return data.data;
};
